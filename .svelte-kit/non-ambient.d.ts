...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/dashboard" | "/dashboard/cetak" | "/dashboard/pengaturan" | "/dashboard/pilih-kelas" | "/dashboard/siswa" | "/dashboard/siswa/edit" | "/dashboard/siswa/edit/[nisn]" | "/dashboard/upload-excel" | "/dashboard/upload-foto" | "/foto" | "/foto/[nisn].jpg" | "/logout" | "/pengaturan" | "/pengaturan/gambar" | "/pengaturan/gambar/[jenis]" | "/siswa";
		RouteParams(): {
		...
		Pathname(): "/" | "/dashboard" | "/dashboard/cetak" | "/dashboard/pengaturan" | "/dashboard/pilih-kelas" | "/dashboard/siswa" | `/dashboard/siswa/edit/${string}` & {} | "/dashboard/upload-excel" | "/dashboard/upload-foto" | `/foto/${string}.jpg` & {} | "/logout" | `/pengaturan/gambar/${string}` & {} | "/siswa";
