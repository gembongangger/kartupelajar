...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/dashboard" | "/dashboard/cetak" | "/dashboard/pengaturan" | "/dashboard/pilih-kelas" | "/dashboard/siswa" | "/dashboard/siswa/edit" | "/dashboard/siswa/edit/[nisn]" | "/dashboard/test-print" | "/dashboard/upload-excel" | "/dashboard/upload-foto" | "/foto" | "/foto/[nisn].jpg" | "/logout" | "/pengaturan" | "/pengaturan/gambar" | "/pengaturan/gambar/[jenis]" | "/siswa";
		RouteParams(): {
			"/dashboard/siswa/edit/[nisn]": { nisn: string };
			"/foto/[nisn].jpg": { nisn: string };
			"/pengaturan/gambar/[jenis]": { jenis: string }
		};
		LayoutParams(): {
			"/": { nisn?: string; jenis?: string };
			...
			"/dashboard/siswa/edit/[nisn]": { nisn: string };
			"/dashboard/test-print": Record<string, never>;
			"/dashboard/upload-excel": Record<string, never>;
			"/dashboard/upload-foto": Record<string, never>;
			"/foto": { nisn?: string };
			"/foto/[nisn].jpg": { nisn: string };
			"/logout": Record<string, never>;
			"/pengaturan": { jenis?: string };
			"/pengaturan/gambar": { jenis?: string };
			"/pengaturan/gambar/[jenis]": { jenis: string };
			"/siswa": Record<string, never>
		};
		Pathname(): "/" | "/dashboard" | "/dashboard/cetak" | "/dashboard/pengaturan" | "/dashboard/pilih-kelas" | "/dashboard/siswa" | `/dashboard/siswa/edit/${string}` & {} | "/dashboard/test-print" | "/dashboard/upload-excel" | "/dashboard/upload-foto" | `/foto/${string}.jpg` & {} | "/logout" | `/pengaturan/gambar/${string}` & {} | "/siswa";
